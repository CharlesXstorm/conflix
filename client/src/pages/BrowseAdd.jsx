...
import jsonData from "../utils/DefaultIProfiles.json";
...
const BrowseAdd = ({setAddProfile}) => {
  ...
  return (
    <div className="absolute z-[20] top-0 left-0 w-[100%] h-[100vh] text-white bg-[#121212]">
        ...
        <div className="w-[100%] lg:w-[60%] xl:w-[40%] m-[auto] px-[6%] md:px-[12%] lg:px-0 flex flex-col">
          ...
          <div className="w-full flex flex-col gap-4 py-4 lg:py-0 mt-4 lg:mt-8">
            <div className="flex flex-col md:flex-row gap-4 lg:gap-6 justify-left md:items-center">
              <span>
                <img className="w-[10em] lg:w-[16em]" src={profileIcon} alt="icon" />
              </span>
              ...
              <div className="w-full flex flex-col">
                ...
                <div className="w-full flex flex-row gap-8">
                  <span className="w-full">
                    ...
                    className={`h-[2em] px-[0.6em] text-[rgb(200,200,200)] text-2xl ${error.have && error.style}`} />
                  </span>
                  <span className="flex gap-4 lg:gap-5 items-center ">
                    <input type="checkbox" className="scale-[2] lg:scale-[3] bg-[transparent] rounded-none" />
